        ...
        'questions': {
            question_id: {
                ...
                'instructions': (
                    ...
                    '加盟店名と金額から、この支出が属する家計簿カテゴリを1つ選んでください。'
                    '加盟店名はカード会社が半角カナ・略称で記録したもので、長音は「-」で表され、'
                    '濁点や小書き文字が崩れることがあります。'
                    'まずカナを漢字に読み替えて意味を取ってください'
                    '(例: デンワリヨウリヨウ=電話利用料、ホケンリヨウ=保険料、デンリヨク=電力)。'
                    '「○ガツブン」「○ネン○ガツ」は「○月分」の月次請求を意味し、'
                    '通信・電気ガス・保険・サブスクなど定期支払いの明細です。'
                ),
